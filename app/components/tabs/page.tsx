...
export default function TabsPage() {
  ...
  return (
    <DSLayout
      title="Tabs"
      description="Three tab variants for different contexts: underline (primary navigation), pill (compact toggles), border (segmented control). All share 12px text and consistent active states."
    >
